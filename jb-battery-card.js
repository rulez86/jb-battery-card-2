...
class JbBatteryCard extends HTMLElement {
    ...
    setConfig(config) {
        if (!config.entity1) {
            throw new Error("Please define entity1");
        }
        ...
        // Entity 1
        const entity1Parts = this._splitEntityAndAttribute(cardConfig.entity1);
        cardConfig.entity1 = entity1Parts.entity;
        if (entity1Parts.attribute) cardConfig.attribute1 = entity1Parts.attribute;
        ...
        card.querySelector("#battery1").addEventListener("click", event => {
            this._fire("hass-more-info", { entityId: cardConfig.entity1 });
        });
    ...
    set hass(hass) {
        ...
        // Entity 1
        const entityState1 = parseInt(this._getEntityStateValue(hass.states[config.entity1], config.attribute1), 10) || '-';
        const statusEntityState1 = this._getEntityStateValue(hass.states[config.entity1], config.status_attribute1);
